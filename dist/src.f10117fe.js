  ...
  _createClass(View, [{
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        ...
        var _eventKey$split = eventKey.split(':'),
            ...
            selector = _eventKey$split2[1]; //retorna um array com os valores de selector
    ...
    value: function mapRegions(fragment) {
      ...
      for (var key in regionsMap) {
        ...
        var element = fragment.querySelector(selector); //verifica se o elemento existe, aceita apenas se o valor não for null ou undefined
    ...
    value: function render() {
      ...
      this.parent.innerHTML = ''; //converte a string em um template HTML do tipo 'template'

      var templateElement = document.createElement('template'); //joga o conteudo de template() em templateElement

      templateElement.innerHTML = this.template(); //amarra os eventos no HTML

      this.bindEvents(templateElement.content);
      this.mapRegions(templateElement.content);
      this.onRender(); //anexa o conteudo de templateElement em parent
...
var UserShow = /*#__PURE__*/function (_View_1$View) {
  ...
  _createClass(UserShow, [{
    ...
    value: function template() {
      return "\n      <div>\n        <h1>Detalhes do usuario:</h1>\n        <div>Usuario: ".concat(this.model.get('name'), "</div>\n        <div>Idade: ").concat(this.model.get('age'), "</div>\n      </div>\n    ");
    }
  }]);
...
"use strict"; //gerencia todos os eventos de um usuario
...
var Eventing_1 = require("./Eventing"); //recebe dois tipos de dados em T e K
...
var Attributes = /*#__PURE__*/function () {
  function Attributes(data) {
    ...
    this.data = data; //<K extends keyof T> informa que K pode ser apenas um dos tipos de dados de T
...
var ApiSync = /*#__PURE__*/function () {
  ...
  _createClass(ApiSync, [{
    ...
    value: function save(data) {
      var id = data.id; //pega o valor de id (vindo de data) e joga na variavel id
